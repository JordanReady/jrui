...
const Header = () => {
  return (
    <div className="bg-white p-4 flex justify-center md:justify-between items-center align-middle border-t-0 border-l-0 border-r-0 shadow fixed w-full top-0 z-50 max-w-[100dvw]">
      <Link href={"/"}>
