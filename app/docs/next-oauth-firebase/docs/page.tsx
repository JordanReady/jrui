  ...
  return (
    <DocLayout>
      <Reveal className="container mx-auto py-8">
        <h1 className="text-4xl font-bold mb-4">Docs Layout</h1>
          ...
          <section className="mb-8">
            ...
            <Reveal className="flex flex-wrap gap-2">
              <Reveal className="btn-hover border-gradient border mt-2 py-2 px-4 w-max">
                <Link
                  target="blank"
                  href={"https://next-oauth-firebase-docs-layout.vercel.app/"}
                >
                  Live Preview
                </Link>
              </Reveal>
        ...
        <Reveal>
          <section className="mb-8">
            ...
            <ol>
              ...
              <pre className="w-max dark:bg-[#3b3b3b] bg-gray-200 p-4 rounded-md">
                cp .env.example .env
              </pre>
              <li>
